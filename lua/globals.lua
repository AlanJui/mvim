...
local packer_root = runtime_dir .. "/site/pack"
local plugins_root = packer_root .. "/packer/start"
local install_path = plugins_root .. "/packer.nvim"
local compile_path = runtime_dir .. "/plugin/packer_compiled.lua"

local snippets_path = {
	config_dir .. "/my-snippets",
	plugins_root .. "/friendly-snippets",
}
